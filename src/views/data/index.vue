<template>
  <div class="execution">
    ...
    <div class="data-manage">
      ...
      <div :style="{ height: divHeight }">
        ...
        <div style="margin: 20px 80px">
          <a-button style="margin-right: 12px" type="primary" size="small" @click="upFile">
            上传文件
          </a-button>
      ...
      <el-row :span="24">
        <el-col :span="24">
          <uploader :options="fileoptions" class="uploader-style">
            ...
            <uploader-btn :directory="true" class="right">选择文件夹</uploader-btn>
            <uploader-drop>
              <p>可以把文件拖拽到这上传</p>
            </uploader-drop>
    ...
    <el-dialog title="创建文件夹" :visible.sync="createFolderShow" class="avue-dialog" v-dialogdrag width="35%">
      ...
      <el-row :span="24">
        <el-col :span="24">
          <el-input placeholder="请输入新文件夹名" v-model="FolderName" clearable>
          </el-input>
        </el-col>
      </el-row>
      <span slot="footer" class="dialog-footer">
